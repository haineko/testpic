	...
	var PageSlides = {
		...
		nav : {
			...
			create : function(){
				...
				var navRight = screenSize() ? 0 : -55;
				var pointerMinWidth = screenSize()? 0 : 5;
				...
				$(this.$ul).find("li").each(function(n, el){
					...
					$a.css({
						...
						padding: "15px 5px", boxSizing: "border-box",
			...
			rollUp : function(){
				TweenLite.to( this.$pointerMin, 0.1, { css: {width: 5}, ease: Power4.easeOut, delay: 0 } );
				TweenLite.to( this.$nav, 0.1, { css: {right: -55}, ease: Power4.easeOut, delay: 0 } );
			},
